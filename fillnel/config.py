...
EMBED_BATCH_SIZE = _env_int("EMBED_BATCH_SIZE", 25)  # Embedding 1リクエストあたりの件数（TPM制限対策）
EMBED_EXCERPT_MAX_CHARS = _env_int("EMBED_EXCERPT_MAX_CHARS", 200)  # Embedding対象テキストのexcerpt最大文字数
